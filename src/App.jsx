...
function App() {
    ...
    return(
        ...
        <button onClick={counterIncrease}>increment:{Counter}</button>
        <button onClick={counterReset}>Reset:{Counter}</button>
        <button onClick={counterDecrease}>decrement:{Counter}</button>
        </>
